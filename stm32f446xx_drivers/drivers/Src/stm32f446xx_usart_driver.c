 ...
 *
 * @brief								- This function enables or disables peripheral clock for the given USARTx bus
 *
 * @param[USART_RegDef_t *pUSARTx]		- Base Address of the USARTx Peripheral
 * @param[uint32_t BaudRate]			- Baud rate of the UARTx Peripheral
 * @return								- None
 *
 * @note								- None
 *****************************************************************************************************************/
 ...
 * @fn									- USART_Init
 *
 * @brief								- This function will Initalize the USARTx Peripheral
 *
 * @param[USART_Handle_t *pUSARTHandle]	- Pointer to the Handle structure
 *
 * @return								- None
 *
 * @note								- None
 ...
 * @fn									- USART_DeInit
 *
 * @brief								- This function will DeInitalize the USARTx Peripheral
 *
 * @param[USART_RegDef_t *pUSARTx]		- Base Address of the USARTx Peripheral
 *
 * @return								- None
 ...
 * @param[USART_RegDef_t *pUSARTx]		- Peripheral Register Definition
 *
 ...
 *
 * @param[USART_Handle_t *pUSARTHandle]		- Base Address of the USARTx Peripheral
 ...
 *
 * @param[USART_Handle_t *pUSARTHandle]	- USARTx peripheral handler structure
 ...
 *
 * @param[SPI_Handle_t *pUSARTHandle]		- USARTx peripheral handler structure
 ...
 *
 * @param[USART_Handle_t *pHandle]		- UARTx IRQHandling Struct
 * @return								- None
 *
 * @note								- None
 *****************************************************************************************************************/
 ...
 *
 * @brief								- This function will enable the USARTx peripheral
 *
 * @param[USART_RegDef_t *pUSARTx]		- Base address of the USARTx (x: 1, 2) peripheral
 * @param[uint8_t EnOrDi]				- Enable/Disable the USARTx peripheral
 * @return								- None
 *
 * @note								- None
 *****************************************************************************************************************/
 ...
 *
 * @param[USART_RegDef_t *pUSARTx]			- Base address of the SPIx (x: 1, 2) peripheral
 * @return								- None
 *
 * @note								- None
 *****************************************************************************************************************/
 ...
 *
 * @param[USART_Handle_t *pUSARTHandle]	- USARTx peripheral Handler
